...
--%>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-primary">
        ...
        <a class="btn btn-primary" href="${pageContext.request.contextPath}/student_leave?sid=${student.sid}">请假申请</a>|
        <a class="btn btn-primary" href="/leave/leaveInfo?sid=${student.sid}">请假详情</a>|
